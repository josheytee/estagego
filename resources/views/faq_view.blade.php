...
@section('content')
    ...
    @php
        ...
        $faq_id = 1;
        $faqs = Faq::where('subcategory_name', '=', $subcategory)->where('category_id', '=', $faq_id);
        $subCategories = SubCategory::with(['Faq'])
            ...
            <div class="nav-item">
                @foreach ($categories as $category)
                    @foreach ($category->SubCategory as $subCategory)
                        <a class="dark_btn"
                            href="{{ url('faq_view/' . $subCategory->category_id . '?subcategory=' . $subCategory->subcategory_name) }}">{{ $subCategory->subcategory_name }}</a>
                        &nbsp; &nbsp; &nbsp;
                    @endforeach
                @endforeach
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="free_text">
                            <div class="section_title">
                                ...
                                <p>Download EstateGO for Free</p>
                            </div>
                            <ul class="app_btn">
                                <li>
                                    <a href="https://play.google.com/store/apps/details?id=com.estatego.tithcqo">
                    ...
                    <div class="col-md-6">
                        <div class="free_img">
                            ...
                            <img class="mobile_mockup" src="{{ asset('asset/images/download-screen02.png') }}"
                                alt="image">
                        </div>
                    </div>
                </div>
