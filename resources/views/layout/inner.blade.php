                        ...
                        <ul class="navbar-nav ml-auto">
                            @foreach ($pages as $page)
                                <li class="{{ $page->class1 }}">
                                    @if ($page->pageName == 'Feature' || $page->pageName == 'How it works')
                                        <a class="{{ $page->class2 }}"
                                            href="{{ url('/') . $page->url }}">{{ $page->pageName }}</a>
                                    @else
                                        <a class="{{ $page->class2 }}"
                                            href="{{ url("$page->url") }}">{{ $page->pageName }}</a>
                                    @endif
                                        ...
                                        <div class="sub_menu">
                                            ...
                                            <ul>
                                                @foreach ($page->Categories as $dropdown)
                                                    <li><a
                                                            href="{{ url($dropdown->url . '/' . $dropdown->id . '?subcategory=GETTING STARTED') }}">{{ $dropdown->category_name }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        ...
                                        <div class="sub_menu">
                                            ...
                                            <ul>
                                                @foreach ($page->ServicePage as $dropdown)
                                                    <li><a
                                                            href="{{ url('services/' . $dropdown->id) }}">{{ $dropdown->title }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
