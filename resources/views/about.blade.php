...
@section('content')
              ...
              <p data-aos="fade-up" data-aos-duration="1500">
                ...
                <div class="col-lg-6">
                    <div class="app_images" data-aos="fade-in" data-aos-duration="1500">
                        <ul>
                            <li><img src="{{ asset('asset/images/about/smiling_house.avif') }}" style="width: 400px"
                                    alt=""></li>
                            <li>
                                <a class="popup-youtube play-button"
                                    data-url="https://www.youtube.com/embed/GdvzcW1HUg4?autoplay=1&mute=1"
                                    data-toggle="modal" data-target="#myModal" title="About Video">
                                    <img src="{{ asset('asset/images/about/construct.jpg') }}" style="width:250px"
                                        alt="">
                                    ...
                                    <span class="play_icon"><img src="{{ asset('asset/images/play_black.png') }}"
                                            alt="image"></span>
                                </a>
                            </li>
                            <li><img src="{{ asset('asset/images/about/house_keys.avif') }}"
                                    style="width: 300px; height:300px; object-fit:cover;" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="about_text">
                        ...
                        <ul class="app_statstic" id="counter" data-aos="fade-in" data-aos-duration="1500">
                            <li>
                                ...
                                <div class="text">
                                    <p><span class="counter-value"
                                            data-count="{{ $home->total_downloads }}">0</span><span>+</span></p>
                                    <p>Download</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="text">
                                    <p><span class="counter-value" data-count="{{ $home->total_users }}">0
                                        </span><span>K+</span></p>
                                    <p>Followers</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="text">
                                    <p><span class="counter-value"
                                            data-count="{{ $reviews->count() }}">1500</span><span>+</span></p>
                                    <p>Reviews</p>
                                </div>
                            </li>
                            <li>
    ...
    <section class="row_am experts_team_section">
        <div class="container">
            <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                ...
                <!-- p -->
                <p>
                    Discover the team behind our success. With expertise across various fields, our professionals are
                    dedicated to delivering exceptional results. <br> Each expert brings a unique perspective and a wealth
                    of knowledge to our work.
                </p>
            </div>
            <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                        <div class="experts_box">
                            ...
                            @if (count($expert->images))
                                <img src="{{ asset('storage/experts/images/' . $expert->images[0]->path) }}"
                                    alt="{{ $expert->images[0]->path }}">
                            @endif
                            <div class="text">
                                <h3>{{ $expert->name }}</h3>
    ...
    <section class="row_am query_section">
        <div class="query_inner" data-aos="fade-in" data-aos-duration="1500">
            <div class="container">
                <!-- shape animation  -->
                <span class="banner_shape1"> <img src="{{ asset('asset/images/banner-shape1.png') }}" alt="image">
                </span>
                <span class="banner_shape2"> <img src="{{ asset('asset/images/banner-shape2.png') }}" alt="image">
                </span>
                <span class="banner_shape3"> <img src="{{ asset('asset/images/banner-shape3.png') }}" alt="image">
                </span>
