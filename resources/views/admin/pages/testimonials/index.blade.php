            ...
            <tr>
                ...
                <td>
                    @if (count($testimonial->images))
                        <img src="{{ asset('storage/testimonials/images/' . $testimonial->images[0]->path) }}"
                            alt="{{ $testimonial->images[0]->path }}" style="width: 100px; height: 50px; object-fit: cover;">
                    @endif
                ...
                <td>
                    ...
                    <a onclick="sendDelete('{{ route('admin.testimonials.destroy', ['testimonial' => $testimonial->id]) }}')"
                        href="#" data-method="DELETE" data-confirm="Are you sure to delete this item?"
