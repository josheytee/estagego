            ...
            <tr>
                ...
                <td>
                    @if (count($blog->images))
                        <img src="{{ asset('storage/blogs/images/' . $blog->images[0]->path) }}"
                            alt="{{ $blog->images[0]->path }}" style="width: 100px; height: 50px; object-fit: cover;">
                    @endif
                </td>
                ...
                <td>
                    ...
                    <a onclick="sendDelete('{{ route('admin.blogs.destroy', $blog) }}')" href="#" data-method="DELETE"
