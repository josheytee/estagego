            ...
            <ul class="app_btn">
              <li>
                <a href="{{$home->appstore_url}}">
                  ...
                  <img class="white_img" src="{{asset('asset/images/appstore_white.png')}}" alt="image" >                </a>              </li>
              <li>
                <a href="{{$home->googleplay_url}}"">
                  <img class="blue_img" src="{{asset('asset/images/googleplay_blue.png')}}" alt="image" >
                  <img class="white_img" src="{{asset('asset/images/googleplay_white.png')}}" alt="image" >                </a>              </li>
            </ul>
    ...
    <section class="row_am features_section" id="features">
      ...
      <div class="container">
        <div class="section_title" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
          ...
          <!-- p -->
          <p>Our revolutionary app provides effective property management solutions for property owners, facility managers and tenants <br>by streamlining operations, saving time and effort, and maximizing profits all from the comfort of your smartphone.</p>.
        </div>
        <div class="feature_detail">
          ...
          <div class="left_data feature_box">
            ...
            <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
              <div class="icon">
                <!--<img src="images/secure_data.png" alt="image" >-->              </div>
              <div class="text">
                <h4>{{$feature->title}} </h4>
                <p>{{$feature->content}}</p>
              </div>
          ...
          <div class="right_data feature_box">
            ...
            <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
              <div class="icon">
                <!--<img src="images/live-chat.png" alt="image" >-->              </div>
              <div class="text">
                <h4>{{$feature->title}} </h4>
                <p>{{$feature->content}}</p>
              </div>
          ...
          <!-- feature image -->
          <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100"><img src="{{asset('asset/images/features_frame.png')}}" alt="image" width="350" ></div>
        </div>
      </div>
      <!-- container end -->
    </section>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="about_img" data-aos="fade-in" data-aos-duration="1500">
              <div class="frame_img">
                <img class="moving_position_animatin" src="{{asset('asset/images/about-frame.png')}}" alt="image" height="580" >              </div>
              <div class="screen_img">
                <img class="moving_animation" src="{{asset('asset/images/about-screen.png')}}" alt="image" >              </div>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="about_text">
              ...
              <ul class="app_statstic" id="counter" data-aos="fade-in" data-aos-duration="1500">
                <li>
                  ...
                  <div class="text">
                    <p><span class="counter-value" data-count="{{$home->total_downloads}}">0</span>K+<span></span></p>
                    <p>Download</p>
                  </div>
                </li>
                <li>
                  ...
                  <div class="text">
                    <p><span class="counter-value" data-count="{{$home->total_household}}">0 </span><span>K+</span></p>
                    <p>Households</p>
                  </div>
                </li>
                <li>
                  ...
                  <div class="text">
                    <p><span class="counter-value" data-count="{{$home->total_cities}}">0</span><span>+</span></p>
                    <p>Cities</p>
                  </div>
                </li>
                <li>
              ...
              <!-- UL end -->
              <a href="#" class="btn puprple_btn" data-aos="fade-in" data-aos-duration="1500">Sign up & Share</a>
            </div>
          </div>
        </div>
        <!-- row end -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="{{asset('asset/images/modern01.png')}}" alt="image" >              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="{{asset('asset/images/secure_data.png')}}" alt="image" >
                <img class="moving_position_animatin" src="{{asset('asset/images/modern02.png')}}" alt="image" >
                <img class="moving_position_animatin" src="{{asset('asset/images/modern03.png')}}" alt="image" >              </div>
            </div>
          </div>
        </div>
        <!-- row end -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="free_img">
                            ...
                            <img class="mobile_mockup" src="{{('asset/images/about-frame.png')}}" alt="image" >                        </div>
                    </div>
                </div>
                <!-- row end -->
            </div>
