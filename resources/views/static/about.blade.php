                        ...
                        <ul>
                            <li>
                                <a class="popup-youtube play-button"
                                    data-url="https://www.youtube.com/embed/4jnzf1yj48M?autoplay=1&mute=1"
                                    ...
                                    <img src="{{ asset('asset/images/about/smiling_house.avif') }}" style="width: 400px"
                                        alt="">
                            ...
                            <li>
                                <a class="popup-youtube play-button"
                                    data-url="https://www.youtube.com/embed/4jnzf1yj48M?autoplay=1&mute=1"
                                    data-toggle="modal" data-target="#myModal" title="About Video">
                                    <img src="{{ asset('asset/images/about/house_keys.avif') }}"
