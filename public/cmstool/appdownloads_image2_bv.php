...
$appdownloads_image2_blobview = NULL; // Initialize page object first

class cappdownloads_image2_blobview extends cappdownloads {
	...
	// Page object name
	var $PageObjName = 'appdownloads_image2_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('appdownloads', 'x_image2');
...
// Create page object
if (!isset($appdownloads_image2_blobview)) $appdownloads_image2_blobview = new cappdownloads_image2_blobview();

// Page init
$appdownloads_image2_blobview->Page_Init();

// Page main
$appdownloads_image2_blobview->Page_Main();
?>
<?php
$appdownloads_image2_blobview->Page_Terminate();
?>
