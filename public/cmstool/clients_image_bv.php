...
$clients_image_blobview = NULL; // Initialize page object first

class cclients_image_blobview extends cclients {
...
// Create page object
if (!isset($clients_image_blobview)) $clients_image_blobview = new cclients_image_blobview();
