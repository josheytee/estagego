...
define("EW_PROJECT_NAME", "EstateGO", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{B5C7A834-3426-4989-B956-81B68DFE8162}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'ufcI3mhW4uRQ69ev', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/EstateGO.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'estatego_staunch', TRUE);
define("EW_CONN_PASS", 'id+lS]CH_Ono@', TRUE);
define("EW_CONN_DB", 'estatego_db', TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "..\public/asset/images/", TRUE); // Upload destination path (relative to app root)
