...
$authors_image_blobview = NULL; // Initialize page object first

class cauthors_image_blobview extends cauthors {
	...
	// Page object name
	var $PageObjName = 'authors_image_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('authors', 'x_image');
...
// Create page object
if (!isset($authors_image_blobview)) $authors_image_blobview = new cauthors_image_blobview();

// Page init
$authors_image_blobview->Page_Init();

// Page main
$authors_image_blobview->Page_Main();
?>
<?php
$authors_image_blobview->Page_Terminate();
?>
