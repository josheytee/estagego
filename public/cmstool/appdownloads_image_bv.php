...
$appdownloads_image_blobview = NULL; // Initialize page object first

class cappdownloads_image_blobview extends cappdownloads {
	...
	// Page object name
	var $PageObjName = 'appdownloads_image_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('appdownloads', 'x_image');
...
// Create page object
if (!isset($appdownloads_image_blobview)) $appdownloads_image_blobview = new cappdownloads_image_blobview();

// Page init
$appdownloads_image_blobview->Page_Init();

// Page main
$appdownloads_image_blobview->Page_Main();
?>
<?php
$appdownloads_image_blobview->Page_Terminate();
?>
