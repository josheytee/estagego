...
//
// Table class for sub_categories
//
class csub_categories extends cTable {
	var $id;
	var $category_id;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('sub_categories', 'sub_categories', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// category_id
		$this->category_id = new cField('sub_categories', 'sub_categories', 'x_category_id', 'category_id', '`category_id`', '`category_id`', 19, -1, FALSE, '`category_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->category_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['category_id'] = &$this->category_id;

		// subcategory_name
		$this->subcategory_name = new cField('sub_categories', 'sub_categories', 'x_subcategory_name', 'subcategory_name', '`subcategory_name`', '`subcategory_name`', 200, -1, FALSE, '`subcategory_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['subcategory_name'] = &$this->subcategory_name;

		// url
		$this->url = new cField('sub_categories', 'sub_categories', 'x_url', 'url', '`url`', '`url`', 200, -1, FALSE, '`url`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['url'] = &$this->url;

		// created_at
		$this->created_at = new cField('sub_categories', 'sub_categories', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('sub_categories', 'sub_categories', 'x_updated_at', 'updated_at', '`updated_at`', 'DATE_FORMAT(`updated_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`sub_categories`";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("sub_categoriesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("sub_categoriesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "sub_categoriesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("sub_categoriesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("sub_categoriesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("sub_categoriesdelete.php", $this->UrlParm());
	}
