...
$service_pages_image_blobview = NULL; // Initialize page object first

class cservice_pages_image_blobview extends cservice_pages {
	...
	// Page object name
	var $PageObjName = 'service_pages_image_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('service_pages', 'x_image');
...
// Create page object
if (!isset($service_pages_image_blobview)) $service_pages_image_blobview = new cservice_pages_image_blobview();

// Page init
$service_pages_image_blobview->Page_Init();

// Page main
$service_pages_image_blobview->Page_Main();
?>
<?php
$service_pages_image_blobview->Page_Terminate();
?>
