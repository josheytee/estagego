...
//
// Table class for blogs
//
class cblogs extends cTable {
	var $id;
	var $author_id;
	var $title;
	var $caption;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('blogs', 'blogs', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// author_id
		$this->author_id = new cField('blogs', 'blogs', 'x_author_id', 'author_id', '`author_id`', '`author_id`', 19, -1, FALSE, '`author_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->author_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['author_id'] = &$this->author_id;

		// title
		$this->title = new cField('blogs', 'blogs', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// caption
		$this->caption = new cField('blogs', 'blogs', 'x_caption', 'caption', '`caption`', '`caption`', 200, -1, FALSE, '`caption`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['caption'] = &$this->caption;

		// content
		$this->content = new cField('blogs', 'blogs', 'x_content', 'content', '`content`', '`content`', 201, -1, FALSE, '`content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['content'] = &$this->content;

		// image
		$this->image = new cField('blogs', 'blogs', 'x_image', 'image', '`image`', '`image`', 200, -1, TRUE, '`image`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['image'] = &$this->image;

		// date
		$this->date = new cField('blogs', 'blogs', 'x_date', 'date', '`date`', '`date`', 200, -1, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['date'] = &$this->date;

		// tags
		$this->tags = new cField('blogs', 'blogs', 'x_tags', 'tags', '`tags`', '`tags`', 200, -1, FALSE, '`tags`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tags'] = &$this->tags;

		// top_blog
		$this->top_blog = new cField('blogs', 'blogs', 'x_top_blog', 'top_blog', '`top_blog`', '`top_blog`', 3, -1, FALSE, '`top_blog`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->top_blog->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['top_blog'] = &$this->top_blog;

		// created_at
		$this->created_at = new cField('blogs', 'blogs', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('blogs', 'blogs', 'x_updated_at', 'updated_at', '`updated_at`', 'DATE_FORMAT(`updated_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("blogsview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("blogsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("blogsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("blogsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("blogsdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->top_blog->Exportable) $Doc->ExportCaption($this->top_blog);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->top_blog->Exportable) $Doc->ExportField($this->top_blog);
