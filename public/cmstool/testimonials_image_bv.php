...
$testimonials_image_blobview = NULL; // Initialize page object first

class ctestimonials_image_blobview extends ctestimonials {
	...
	// Page object name
	var $PageObjName = 'testimonials_image_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('testimonials', 'x_image');
...
// Create page object
if (!isset($testimonials_image_blobview)) $testimonials_image_blobview = new ctestimonials_image_blobview();

// Page init
$testimonials_image_blobview->Page_Init();

// Page main
$testimonials_image_blobview->Page_Main();
?>
<?php
$testimonials_image_blobview->Page_Terminate();
?>
