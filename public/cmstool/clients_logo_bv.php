...
$clients_logo_blobview = NULL; // Initialize page object first

class cclients_logo_blobview extends cclients {
	...
	// Page object name
	var $PageObjName = 'clients_logo_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('clients', 'x_logo');
...
// Create page object
if (!isset($clients_logo_blobview)) $clients_logo_blobview = new cclients_logo_blobview();

// Page init
$clients_logo_blobview->Page_Init();

// Page main
$clients_logo_blobview->Page_Main();
?>
<?php
$clients_logo_blobview->Page_Terminate();
?>
