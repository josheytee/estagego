...
$services_image_blobview = NULL; // Initialize page object first

class cservices_image_blobview extends cservices {
	...
	// Page object name
	var $PageObjName = 'services_image_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('services', 'x_image');
...
// Create page object
if (!isset($services_image_blobview)) $services_image_blobview = new cservices_image_blobview();

// Page init
$services_image_blobview->Page_Init();

// Page main
$services_image_blobview->Page_Main();
?>
<?php
$services_image_blobview->Page_Terminate();
?>
