...
class cusers extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('users', 'users', 'x_id', 'id', '`id`', '`id`', 21, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// email_verified_at
		$this->email_verified_at = new cField('users', 'users', 'x_email_verified_at', 'email_verified_at', '`email_verified_at`', 'DATE_FORMAT(`email_verified_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`email_verified_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->email_verified_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		...
		// created_at
		$this->created_at = new cField('users', 'users', 'x_created_at', 'created_at', '`created_at`', 'DATE_FORMAT(`created_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->created_at->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['created_at'] = &$this->created_at;

		// updated_at
		$this->updated_at = new cField('users', 'users', 'x_updated_at', 'updated_at', '`updated_at`', 'DATE_FORMAT(`updated_at`, \'%Y/%m/%d\')', 135, 5, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
