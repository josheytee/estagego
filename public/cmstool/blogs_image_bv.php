...
$blogs_image_blobview = NULL; // Initialize page object first

class cblogs_image_blobview extends cblogs {
	...
	// Page object name
	var $PageObjName = 'blogs_image_blobview';
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('blogs', 'x_image');
...
// Create page object
if (!isset($blogs_image_blobview)) $blogs_image_blobview = new cblogs_image_blobview();

// Page init
$blogs_image_blobview->Page_Init();

// Page main
$blogs_image_blobview->Page_Main();
?>
<?php
$blogs_image_blobview->Page_Terminate();
?>
